...
double clsVector2d::distanceSq(const clsVector2d &v2) const
{
    double SqDistance = (this->_x - v2.getX()) * (this->_x - v2.getX()) + (this->_y - v2.getY()) * (this->_y - v2.getY());
    return SqDistance;
}

double clsVector2d::distance(const clsVector2d &v2) const
{
    return sqrt(distanceSq(v2));
}

clsVector2d clsVector2d::GetReverse() const
{
    return clsVector2d(-_x, -_y);
}
